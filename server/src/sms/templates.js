module.exports = (type, user) => {
  ...
  const template = {
    ...
    creationAtrialFibrillationNew: `היי, קיבלת מרשם לתרופה חדשה. מצורף מערך הדרכה ובו סרטון מותאם אישית שיעזור לך להבין טוב יותר את הבריאותי ולמה חשוב להתמיד בנטילת התרופה\n${FirstSend}`,
